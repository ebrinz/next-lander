        ...
        <div class="w-full pb-12">
            <div >
                <div class="transition duration-500 ease-in-out shadow-card hover:shadow-cardhvr rounded ring-1 ring-cardbrd ring-offset-0 ring-offset-cardRingColor">
                    <div class="flex flex-row justify-between px-5 py-3 bg-cardbg border-b-1 border-cardbrd text-xl" onClick={(e) => console.log(e)}>
                    ...
                    <div class="prose prose-sm font-mono px-6 py-6">
